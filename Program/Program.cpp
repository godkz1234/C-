...
void Coordionate(float x, float y, float z = 30)
{
...
#pragma region 스트림
	...
	// 스트림은 운영체제에 의해 생성되며, 스트림 자체에 버리라는 
	// 임시 메모리 공간이 존재합니다.
#pragma endregion
...
#pragma region 동적할당
	...
	// for (int i = 0; i < 3; i++) 
	// {
	// 	std::cout << "newarray가 가리키고 있는 메모리 값["<< i << "] : " << newarray[i] << std::endl;
	// }
	// 
	// 
	// delete ptr;
...
#pragma region 범위 지정 연산자
	...
	// 범위 지정 연산자는 전역 변수와 값은 이름의 지역 변수가 선언되었을
