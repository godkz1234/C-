...
#pragma region 복사 생성자
	...
	// Unit unit3 = unit1; // 밑에것과 같은 의미

	// Unit unit2(unit1); 

	// 복사 생성자를 정의하지 않고, 객체를 복사하게 되면
	// 기본 복사 생성자가 호출되기 때문에 앝은 복사로
	// 객체가 복사됩니다.
...
#pragma region 얕은 복사
	// 객체를 복사할때 주소 값을 복사하여 같은
	// 메모리 공간을 기리키게 하는 복사입니다.
	...
	// 얕은 복사의 경우 객체가 서로 같은 메모리 
	// 공간을 참조하기 때문에 하나의 객체로 값을 
